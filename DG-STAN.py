...
if __name__ == "__main__":
    ...
    # 初始化数据
   # adj_matrix, node_map = DataProcessor.build_adjacency_matrix("distance.csv")
    adj_matrix, node_map = DataProcessor.build_adjacency_matrix("E:\交通流预测研究\other_models\数据集\PeMS04\PeMS04.csv")

    adj_norm = DataProcessor.normalize_adjacency(adj_matrix, config.sigma)
    pems_data, data_mean, data_std = DataProcessor.load_pems_data("E:\交通流预测研究\other_models\数据集\PeMS04\PeMS04.npz", device)
